...
<body>
    <div class="container-fluid">
        <div class="row">
            ...
            <!-- Konten Utama -->
            <div class="col-md-9 col-lg-10 p-4 main-content bg-dark text-white rounded">
                ...
                <form action="{{ route('admin.users.update', $user->id_user) }}" method="POST" class="needs-validation" novalidate>
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="nama_lengkap" name="nama_lengkap" class="form-control" value="{{ $user->nama_lengkap }}" required>
                    </div>
