    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-9 col-lg-10 p-4 main-content">
                ...
                <h1 class="text-white">PERTANYAAN</h1>
                @if (session('success'))
                ...
                <table class="table table-dark table-striped mt-4">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('admin.questions.answers', $question->id) }}" class="btn btn-primary btn-sm">
                                    <i class="fa-solid fa-comment"></i> Lihat Jawaban
                                </a>
                                <form action="{{ route('admin.questions.destroy', $question->id) }}" method="POST" style="display:inline;">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" onclick="return confirm('Yakin ingin menghapus pertanyaan ini?')" class="btn btn-danger btn-sm"><i class="fas fa-trash-alt"></i> Hapus</button>
                                </form>
                            </td>
                        </tr>
                        @endforeach
