...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-light fixed-top bg-light">
    <div class="container">
      ...
      <a class="navbar-brand" href="#">
        <div class="row">
          <div class="col">
            <img src="https://github.com/ridwanhakimr/gambar/blob/main/image/Logo.png?raw=true" alt="logo" width="50" />
          </div>
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ms-auto">
          ...
          <li class="nav-item mx-2">
            <a class="nav-link ms-auto" href="{{ url('/login') }}"> <button class="btn btn-primary d-flex">Sign In</button> </a>
          </li>
        </ul>
      </div>
    </div>
        ...
        <div id="carouselExampleAutoplaying" class="carousel slide" data-bs-ride="carousel">
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="https://github.com/ridwanhakimr/gambar/blob/main/image/carousel1.png?raw=true" class="d-block w-100 rounded" alt="...">
            </div>
            <div class="carousel-item">
              <img src="https://github.com/ridwanhakimr/gambar/blob/main/image/carousel2.png?raw=true" class="d-block w-100 rounded" alt="...">
            </div>
            <div class="carousel-item">
              <img src="https://github.com/ridwanhakimr/gambar/blob/main/image/carousel3.png?raw=true" class="d-block w-100 rounded" alt="...">
            </div>
          </div>
    ...
    <div class="row">
      <div class="col d-flex justify-content-center mt-3">
        <div class="card" style="width: 18rem;">
          <img src="https://github.com/ridwanhakimr/gambar/blob/main/image/bg.jpg?raw=true" class="card-img-top" alt="...">
          <div class="card-body">
  ...
  <div class="container pb-5 mt-5 py-5">
    <div class="row">
      <div class="col-lg-4 d-flex justify-content-center">
        <img src="https://github.com/ridwanhakimr/gambar/blob/main/image/Logo.png?raw=true" alt="" width="250">
    ...
    <div class="container text-center text-md-start">
      <div class="row text-center text-md-start">
        ...
        <div class="col-md-3 col-lg-3 col-xl-3 mx-auto mt-3">
          <img class="img-fluid " width="200" src="https://github.com/ridwanhakimr/gambar/blob/main/image/Logo.png?raw=true" alt="">
        </div>
        <!-- conten -->
  ...
  <script>
    // Set interval to 3 seconds (5000ms)
